...
import pandas as pd
import requests
con=pymysql.connect(host="localhost",user="root",password="Nikitabhole",database="twittersentiment")
def viewallpredexcel(request):
    df=pd.read_csv('C:/Users/nidhi/OneDrive/Desktop/twittersentiment_new/twittersentiment/Recommendationsystem/dataset/tweets.csv')
